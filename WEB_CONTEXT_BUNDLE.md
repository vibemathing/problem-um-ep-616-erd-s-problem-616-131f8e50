...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-616-erd-s-problem-616-131f8e50-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-616"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-616-erd-s-problem-616-131f8e50-v1",
      "problem_contract_sha256": "adf71984c660589581543a447be46bbacfb09515d82b35aafca2914a81648987",
      "problem_id": "problem:um-ep-616-erd-s-problem-616-131f8e50",
      "route_id": "route:um-ep-616-erd-s-problem-616-131f8e50-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-616-erd-s-problem-616-131f8e50-source-fidelity-01",
      "graph_id": "graph:um-ep-616-erd-s-problem-616-131f8e50-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-616-erd-s-problem-616-131f8e50-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-616-erd-s-problem-616-131f8e50-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $r\\geq 3$. For an $r$-uniform hypergraph $G$ let $\\tau(G)$ denote the covering number (or transversal number), the minimum size of a set of vertices which includes at least one from each edge in $G$. Determine the best possible $t$ such that, if $G$ is an $r$-uniform hypergraph $G$ where every subgraph $G'$ on at most $3r-3$ vertices has $\\tau(G')\\leq 1$, we have $\\tau(G)\\leq t$."
          },
          "statement_sha256": "d59f01b05b58e546512b862f744b6ac08625f1dbc4c7478fff050d058917f0ec"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-616-erd-s-problem-616-131f8e50-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-616-erd-s-problem-616-131f8e50-root",
      "route_id": "route:um-ep-616-erd-s-problem-616-131f8e50-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-616-4721a0542e2e",
        "url": "https://www.unsolvedmath.com/problems/EP-616"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
